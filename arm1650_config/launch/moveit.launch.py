...
def generate_launch_description():
    ...
    manipulator_urdf_file = os.path.join(get_package_share_directory('arm1650_config'), 'resource', 'urdf', 'moveit_description.urdf.xacro')
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory('arm1650_config'),
        'resource', 'config',
